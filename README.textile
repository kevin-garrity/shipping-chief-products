...
Add the following to templates/cart.liquid

@{% include 'request-shipping-form' %}@

Add the following to checkout.css.liquid:
...
Wherever you find @{{ cart.item_count }}@ in your @theme.liquid
...
In order to integrate smoothly with your store, WSC imagines that you have adopted certain conventions. This is so that WSC can interact with your store's cart, adding shipping price line items, and manipulating the various inputs.
