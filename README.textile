...
Create a custom collection in your store called shipping, create a product in the new collection called Shipping with the price of 0.01.
...
Add the following to the bottom of assets/checkout.css.liquid. If you don't have a checkout.css.liquid file in your shop already, you should create it. add instruction to create it.

bc. /* Webify Changes
 * */
if checkout.css.liquid not present, creates it.
...
Add item class to each tr in cart.liquid
